...
describe("FundMe", function () {
  ...
  describe("fund", function () {
    ...
    it("Adds funder to array of funders", async function () {
      await fundMe.fund({ value: sendValue });
      const funder: string = await fundMe.s_funders(0); // ** Again, isn't it supposed to be "s_funders[0]"?
  ...
  describe("withdraw", function () {
    ...
    it("Alows us to withdraw from multiple funders", async function () {
      ...
      await expect(fundMe.s_funders(0)).to.be.reverted; // ** Why is "await" not in front of "fundMe.."?
